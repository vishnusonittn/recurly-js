...
// TODO 
const ADYEN_CLIENT_URI = 'https://www.paypalobjects.com/api/checkout.js';
 ...
 * @abstract
 */
export class AdyenStrategy extends Emitter {
  constructor (options) {
    super();
    this.isReady = false;
    this.config = {};
  ...
  configure (options) {
    if (!(options.recurly instanceof Recurly)) throw this.error('adyen-factory-only');
